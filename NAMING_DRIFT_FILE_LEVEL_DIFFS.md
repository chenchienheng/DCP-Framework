...
### Legacy: `04_adapter_layer/` (Source: `origin/xuanling-seed-v0-1`)

Observed files:
- activation_order.md
- gamma_entry_spec.md
- replit_relay_spec.md
- source_map.md
- writeback_gate_spec.md
- writeback_packet_contract.md

Note: Previously listed files (adapter_map.md, source_adapter.md, writeback_adapter.md) were placeholders.

### Canonical: `04_adapter-layer/`

Status:
- file-level comparison completed
- 6 unique seed files identified for rebind
