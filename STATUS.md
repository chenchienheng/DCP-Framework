...
> - **Reader-routing successor:** `docs/alignment/xl00-current-active-index-v0_1.md` on this branch; this is not an identity-successor claim.
> - **Read first:** `README.md`, then this role index.
