...
```yaml
Parked:
  - "old persistent LOR chat windows"
...
Return_Check:
  ...
  bounded_action_completed: false
...
- Pointer != Evidence.
- Parked != Deleted.
- Historical Window != Current Authority.
- Read Order != Automatic Execution.
- Thread Experiment != Runtime.
